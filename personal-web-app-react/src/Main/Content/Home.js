...
const Home = () => {
    return (
        <div className='Home'>
            ...
            <ProjectArticle name="Zesty" descript="A minimalistic online landing page for future projects." pos="right" img='icon/bomberman.png' alt='zesty.png' link='/home/zesty'/>
